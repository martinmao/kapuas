...
public class ShiroUsernamePasswordToken extends UsernamePasswordToken {
    ...
    private org.scleropages.maldini.security.authc.token.client.UsernamePasswordToken nativeToken;
    ...
    public org.scleropages.maldini.security.authc.token.client.UsernamePasswordToken getNativeToken() {
        return nativeToken;
    }

    public void setNativeToken(org.scleropages.maldini.security.authc.token.client.UsernamePasswordToken nativeToken) {
