...
public interface AuthenticationManager {
     ...
     * if given client authentication token is {@link org.scleropages.kapuas.session.StatelessToken} implementation will not initialize server resource.
     *
     * @param authenticationToken
     * @see org.scleropages.kapuas.security.authc.token.client.UsernamePasswordToken
     * @see org.scleropages.kapuas.security.authc.token.client.StatelessUsernamePasswordToken
     */
