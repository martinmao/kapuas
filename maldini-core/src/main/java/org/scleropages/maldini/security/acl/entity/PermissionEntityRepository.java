 ...
 */
public interface PermissionEntityRepository extends CrudRepository<PermissionEntity, Long> {

    List<PermissionEntity> findAllByResourceType(String resourceType);
